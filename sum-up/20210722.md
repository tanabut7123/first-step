...
## การควบคุม exception ของ API

ใช้ ExceptionHandler ในการกำหนด exception แต่ละประเภท
...
แต่ถ้าสร้าง Class ในการควบคุม exception ต้องใช้ RestControllerAdvice เพื่อกำหนดให้ class นี้เป็นตัวควบคุม
